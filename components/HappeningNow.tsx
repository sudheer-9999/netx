...
const HappeningNow = () => {
  return (
    <div className='my-4rect
     w-full md:w-1/2 container '><ElectricBorder
  color="#7df9ff"
  speed={1}
  chaos={0.12}
  ...
  <div >
          ...
          <div className="grid grid-cols-1  items-start">
            <div className="md:col-span-3 rounded-lg border border-white/10 p-6 bg-white/5">
              <h3 className="text-2xl font-semibold">Madhuram – Let’s Jammify</h3>
              ...
              <div className="mt-6">
                <a
                  href="https://konfhub.com/madhuram"
                  target="_blank"
